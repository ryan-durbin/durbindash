...
jest.mock('rss-parser', () => {
  return jest.fn().mockImplementation(() => ({
    parseURL: jest.fn(async (url) => {
      const items = [
        { title: 'Article One', link: 'https://example.com/1', isoDate: '2026-02-28T10:00:00.000Z' },
        { title: 'Article Two', link: 'https://example.com/2', isoDate: '2026-02-28T09:00:00.000Z' },
        { title: 'Article Three', link: 'https://example.com/3', isoDate: '2026-02-28T08:00:00.000Z' },
        { title: 'Article Four', link: 'https://example.com/4', isoDate: '2026-02-27T10:00:00.000Z' },
        { title: 'Article Five', link: 'https://example.com/5', isoDate: '2026-02-27T09:00:00.000Z' },
        { title: 'Article Six', link: 'https://example.com/6', isoDate: '2026-02-27T08:00:00.000Z' },
      ];
      return { items };
    }),
  }));
